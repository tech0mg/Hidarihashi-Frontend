const WeatherInfo = ({ isLoading, data }) => (
    <div className="mb-6">
      <h2 className="text-xl font-bold mb-4 text-center text-gray-600">天気予報</h2>
      <div className="border-2 border-gray-300 p-4 rounded-lg bg-gray-50">
        {isLoading ? (
          <p className="text-sm text-gray-600">天気情報を読み込んでいます...</p>
        ) : data ? (
          <div>
          ...
          <p className="text-sm text-gray-600">天気情報を取得できませんでした。</p>
        )}
      </div>
    </div>
  );
